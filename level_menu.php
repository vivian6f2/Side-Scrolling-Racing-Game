...
<html>
	<head>
		...
		<script type="text/javascript">
			function changeOrderMethod(){
				...
				var new_html = 'http://people.cs.nctu.edu.tw/~tihlin/project/level_menu.php?order='+method;
	...
	<body>
		...
		<?php
			...
			echo '</select>';
			echo '&nbsp;&nbsp;&nbsp;&nbsp;<a href="level_menu_bad.php" target="_self" class="button">回收區</a>';
			echo '</div>';
			echo '<div><div id="makeleft">';
			if ($page>1) echo '<a href="level_menu.php?page='.($page-1).'&order='.$order_type.'" target="_self" class="left" style="margin-top:190px; margin-left:30px;">l</a>';
			else echo '&nbsp;';
			echo '</div>';
			...
			if ($count > ($page*18)) echo '<a href="level_menu.php?page='.($page+1).'&order='.$order_type.'" target="_self" class="right" style="margin-top:190px; margin-left:30px;">r</a>';
			else echo '&nbsp;';
			echo '</div></div>';
